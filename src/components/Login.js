      ...
      <div className="card w-96 m-auto px-3 shadow-sm bg-white">
        <div className="card-body">
          ...
          <div className="card-actions w-full">
            <button className="btn bg-slate-700 hover:bg-slate-600 text-white w-full">로그인</button>
          </div>
          <p className="m-auto text-sm py-2">다른 방법으로 로그인</p>
          <button className="btn bg-white hover:bg-gray-50 input-bordered text-center font-normal relative">
            <img
          ...
          <a className="link text-sm text-center py-2">회원가입</a>
        </div>
      </div>
    </div>
  );
